...
int main()
{
    int espaciosIniciales = 9, espaciosMedios = -1, fila = 1; //Se declaran las variables espaciosIniciales y espaciosMedios de tipo entero que almacenan la cantidad de espacios que se van a imprimir y fila que almacena el número de fila en la que se encuentra el programa
    ...
    while( fila <= 10 ) //Se inicia un ciclo while que se ejecutará mientras la variable fila sea menor o igual a 10 (numero de filas)
    {
        ...
        //Se verifica si fila es diferente de 1 para imprimir la segunda Z al final de cada linea
        if ( fila != 1 )    
            ImprimirLetras( 1 );
